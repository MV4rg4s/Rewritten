...
nation_skinshop = false -- deixe true caso use o script nation_skinshop

creatorCoords = vec3(-235.56,-2002.7,24.68)
creatorHeading = 357.17

spawnCoords = vec3(-544.64,-205.22,38.22)
spawnHeading = 323.15
