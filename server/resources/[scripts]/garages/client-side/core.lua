...
local Garages = {
	...
	--tractor
	["81"] = { x=2258.17,y=5166.06,z=59.11,h=232.45,
...
-- SPAWNPOSITION
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.SpawnPosition(Select)
	local Slot = "0"
	local Checks = 0
	local Selected = {}
	local Position = nil
...
-- CREATEVEHICLE
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.CreateVehicle(Model,Network,Engine,Health,Customize,Windows,Tyres)
...
-- SEARCHBLIP
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.SearchBlip(Coords)
...
-- STOPHOTWIRED
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.StopHotwired(Vehicle)
	Hotwired = false
...
-- UPDATEHOTWIRED
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.UpdateHotwired(Status)
	Hotwired = Status
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- LOOPHOTWIRED
