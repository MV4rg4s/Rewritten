...
local List = {
	...
	{ vec3(1840.21,2578.52,46.08),"Police-2",1.0 },
	{ vec3(1852.87,3687.8,34.08),"Police-3",1.0 },
	{ vec3(-447.27,6013.0,32.42),"Police-4",1.0 },
	{ vec3(-640.89,-2384.62,13.68),"Mechanic",1.0 },
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADSTART
-----------------------------------------------------------------------------------------------------------------------------------------
