...
-----------------------------------------------------------------------------------------------------------------------------------------
ghost = {}
Tunnel.bindInterface("shops",ghost)
...
-- REQUESTPERM
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.requestPerm(Type)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
...
-- REQUESTSHOP
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.requestShop(name)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
		local shopSlots = 20
...
-- GETSHOPTYPE
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.getShopType(Type)
    return shops[Type]["mode"]
end---------------------------------------------------------------------------------------------------------------------------------
-- FUNCTIONSHOP
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.functionShops(Type,Item,Amount,Slot)
	local source = source
