...
-----------------------------------------------------------------------------------------------------------------------------------------
ghost = {}
Tunnel.bindInterface("propertys",ghost)
...
-- OPENCHEST
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.OpenChest(Name,Mode)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
		local Chest = {}
...
-- STORE
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.Store(Item,Slot,Amount,Target,Name,Mode)
	local source = source
...
-- TAKE
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.Take(Slot,Amount,Target,Name,Mode)
	local source = source
	local Amount = parseInt(Amount)
	local Passport = vRP.Passport(source)
	if Passport then
...
-- UPDATE
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.Update(Slot,Target,Amount,Name,Mode)
	local source = source
	local Amount = parseInt(Amount)
	local Passport = vRP.Passport(source)
	if Passport then
