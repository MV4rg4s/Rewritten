...
-----------------------------------------------------------------------------------------------------------------------------------------
ghost = {}
Tunnel.bindInterface("painel",ghost)
...
-- HIERARCHY
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.Hierarchy(OtherPassport,Mode)
	local source = source
	local Passport = vRP.Passport(source)
