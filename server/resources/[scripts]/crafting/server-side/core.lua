...
-----------------------------------------------------------------------------------------------------------------------------------------
ghost = {}
Tunnel.bindInterface("crafting", ghost)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VERIFY
-----------------------------------------------------------------------------------------------------------------------------------------
...
-- PERMISSION
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.Permission(Type)
    local source = source
    local Passport = vRP.Passport(source)
    if Passport then
...
-- FUNCTIONCRAFTING
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.Crafting(Type, Item, Amount)
    local source = source
...
-- OWNED
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.Owned(Liste, Item)
    local Owned = {}
    local source = source
    local Passport = vRP.Passport(source)
...
-- FUNCTIONDESTROY
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.functionDestroy(Item, Type, Amount, Slot)
    local source = source
    local Amount = parseInt(Amount)
    local Passport = vRP.Passport(source)
    if Passport then
