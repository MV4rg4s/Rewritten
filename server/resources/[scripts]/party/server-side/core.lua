...
-----------------------------------------------------------------------------------------------------------------------------------------
ghost = {}
Tunnel.bindInterface("party",ghost)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local Config = {
...
-- GETMEMBERS
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.GetMembers(Number)
	local source = source
	local Passport = vRP.Passport(source)
...
-- CREATEROOM
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.CreateRoom(Name,Password)
	local source = source
	local Passport = vRP.Passport(source)
...
-- CREATEROOM
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.EnterRoom(Number, Password)
	local source = source
	local Passport = vRP.Passport(source)
	...
	if Config["Room"][Number] then
		if Config["Users"][Passport] then
			if Number ~= Config["Users"][Passport] then
				if Config["Users"][Passport] then
					ghost.LeaveRoom(Config["Users"][Passport])
				end
...
-- KICKROOM
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.KickRoom(Kick,Passport)
	local source = source
