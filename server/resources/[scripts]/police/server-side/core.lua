...
-----------------------------------------------------------------------------------------------------------------------------------------
ghost = {}
Tunnel.bindInterface("police",ghost)
...
-- INITPRISON
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.initPrison(nuser_id,services,fines,text)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
...
-- SEARCHUSER
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.searchUser(nuser_id)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
...
-- INITFINE
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.initFine(nuser_id,fines,text)
	local source = source
	local Passport = vRP.Passport(source)
