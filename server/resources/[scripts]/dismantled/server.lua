...
-----------------------------------------------------------------------------------------------------------------------------------------
ghost = {}
Tunnel.bindInterface("dismantled", ghost)
...
------------------------------------------------------
function ghost.GerarPagamento(placa, nomeFeio, nomeBonito, nPassport)
    local source = source
    local Passport = vRP.Passport(source)
