...
-----------------------------------------------------------------------------------------------------------------------------------------
ghost = {}
Tunnel.bindInterface("chest",ghost)
...
-- PERMISSIONS
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.Permissions(Name,Mode)
	local source = source
	local Passport = vRP.Passport(source)
...
-- STORE
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.Store(Item,Slot,Amount,Target)
	local source = source
...
-- TAKE
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.Take(Item,Slot,Amount,Target)
	local source = source
	local Amount = parseInt(Amount)
	local Passport = vRP.Passport(source)
	if Passport and Open[Passport] then
...
-- UPDATE
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.Update(Slot,Target,Amount)
	local source = source
	local Amount = parseInt(Amount)
	local Passport = vRP.Passport(source)
	if Passport and Open[Passport] then
