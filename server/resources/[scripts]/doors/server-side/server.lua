...
-----------------------------------------------------------------------------------------------------------------------------------------
ghost = {}
Tunnel.bindInterface("doors",ghost)
...
GlobalState["Doors"] = {
	...
	-- cassino
	[67] = { x = 947.41, y = 40.65, z = 75.32, hash = 21324050, lock = true, text = true, distance = 10, press = 2, perm = "ghost" },
	[68] = { x = 946.54, y = 41.31, z = 75.32, hash = 21324050, lock = true, text = true, distance = 10, press = 2, perm = "ghost" }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- DOORSSTATISTICS    947.41,40.65,75.32,325.99
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.doorsStatistics(doorNumber,doorStatus)
...
-- DOORSPERMISSION
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.doorsPermission(doorNumber)
	local source = source
