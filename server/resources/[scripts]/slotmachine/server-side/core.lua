...
-----------------------------------------------------------------------------------------------------------------------------------------
ghost = {}
Tunnel.bindInterface("slotmachine",ghost)
...
-- STARTSLOTS
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.StartSlots(Table)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport and Machines[Table] then
		local Result = {
...
-- WINNER
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.Winner(Table,Result)
	local source = source
	local Passport = vRP.Passport(source)
