...
-----------------------------------------------------------------------------------------------------------------------------------------
ghost = {}
Tunnel.bindInterface("inventory",ghost)
...
-- PARACHUTE
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.parachuteColors()
	local Ped = PlayerPedId()
...
-- CHECKWEAPON
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.checkWeapon(Hash)
	if Weapon == Hash then
		return true
	end
...
-- CHECKATTACHS
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.checkAttachs(nameItem,nameWeapon)
	return weaponAttachs[nameItem][nameWeapon]
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- PUTATTACHS
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.putAttachs(nameItem,nameWeapon)
	GiveWeaponComponentToPed(PlayerPedId(),nameWeapon,weaponAttachs[nameItem][nameWeapon])
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- PUTWEAPONHANDS
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.putWeaponHands(Name,Ammo,Components,Type)
	if not TakeWeapon then
		...
		if Components then
			for nameItem,_ in pairs(Components) do
				ghost.putAttachs(nameItem,Name)
			end
		end
...
-- STOREWEAPONHANDS
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.storeWeaponHands()
...
-- RECHARGECHECK
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.rechargeCheck(ammoType)
	local weaponAmmo = 0
...
-- RECHARGEWEAPON
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.rechargeWeapon(Hash,Ammo)
...
-- WHEELCHAIR
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.wheelChair(Plate)
	local Ped = PlayerPedId()
...
-- TYREHEALTH
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.tyreHealth(Network,Tyre)
	if NetworkDoesNetworkIdExist(Network) then
		local Vehicle = NetToEnt(Network)
		if DoesEntityExist(Vehicle) then
...
-- DOESOBJECTEXIST
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.objectExist(Coords,Hash)
...
-- CHECKATM
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.checkAtm(Coords)
...
-- DISMANTLE
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.Dismantle(Experience)
...
-- DISMANTLESTATUS
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.DismantleStatus()
	return disActive
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- INVENTORY:DISRESET
...
-- CHECKMODS
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.CheckMods(Vehicle,Mod)
	return GetNumVehicleMods(Vehicle,Mod) - 1
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- CHECKCAR
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.CheckCar(Vehicle)
	local Model = GetEntityModel(Vehicle)
...
-- ACTIVEMODS
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.ActiveMods(Vehicle,Plate,Mod,Number)
	if NetworkDoesNetworkIdExist(Vehicle) then
		local Vehicle = NetToEnt(Vehicle)
		if DoesEntityExist(Vehicle) then
			if GetVehicleNumberPlateText(Vehicle) == Plate then
...
-- RESTAURANT
-----------------------------------------------------------------------------------------------------------------------------------------
function ghost.Restaurant(Name)
	local Return = false
	local Ped = PlayerPedId()
	local Coords = GetEntityCoords(Ped)
